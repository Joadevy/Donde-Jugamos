...
// Este template esta dirigido a notificar al PROPIETARIO sobre cambios en el estado de la reserva (nueva/pendiente - cancelacion)
													...
													<table class="heading_block block-4" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-left:20px;padding-right:20px;padding-top:30px;text-align:center;width:100%;">
																<h2 style="margin: 0; color: #434852; direction: ltr; font-family: Hind, Nunito, Arial, sans-serif; font-size: 30px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Reserva {{id}} - {{status}}:</span></h2>
															</td>
														</tr>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:20px;padding-right:10px;">
																<div class="levelOne" style="margin-left: 0;">
																	<ul class="leftList" start="1" style="margin-top: 0; margin-bottom: 0; padding: 0; padding-left: 20px; font-weight: 400; text-align: left; color: #101112; direction: ltr; font-family: Hind,Nunito,Arial,sans-serif; font-size: 16px; letter-spacing: 0; line-height: 120%; mso-line-height-alt: 19.2px; list-style-type: disc;">
																		<li style="margin-bottom: 0; text-align: left;">Id: {{id}}</li>
																		...
																		<li style="margin-bottom: 0; text-align: left;">Valor por adelantado: {{partialPayment}}</li>
																		<li style="margin-bottom: 0; text-align: left;">Estado: <strong>{{status}}</strong></li>
																		<li style="margin-bottom: 0; text-align: left;">Motivo o comentario: {{observation}}</li>
																		<li style="margin-bottom: 0; text-align: left;">Nombre del solicitante: {{userName}}</li>
																		<li style="margin-bottom: 0; text-align: left;">Email del solicitante: {{userEmail}}</li>
																	</ul>
																</div>
															</td>
														</tr>
							...
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #9fdbad; color: #000; width: 640px; margin: 0 auto;" width="640">
										<tbody>
											<tr>
												<td class="column column-1" width="100%" style="font-weight: 400; text-align: left; mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding-bottom: 30px; padding-top: 20px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
...
// Este template esta dirigido a notificar al PROPIETARIO sobre cambios en el estado de la reserva (nueva/pendiente - cancelacion)
export const compilePropietaryChangeStatusTemplate = (
  status: string,
  description: string,
  id: number,
